    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">Generate and download spending reports</p>
        </div>
              ...
              <tbody>
                {reports.map((report) => (
                  <tr key={report.id} className="border-b border-gray-100 hover:bg-gray-50">
                    <td className="px-4 py-3 text-gray-900 font-medium">{report.title}</td>
                    <td className="px-4 py-3 text-gray-700 capitalize">{report.type}</td>
                    <td className="px-4 py-3 text-gray-700">{formatDate(report.generated_at)}</td>
                    <td className="px-4 py-3 text-gray-700">{getFileSize(report.file_url)}</td>
